// cart.js - Funcionalidad del carrito de compras para Roldan Games
...
// Evento para añadir al carrito productos de la galería
const setupAddToCartButtons = () => {
  document.querySelectorAll('#caja_galeria button').forEach((button, index) => {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Esperar a que las tarjetas se creen para añadir los event listeners
  setTimeout(setupAddToCartButtons, 100);
});

// Actualizar event listeners cuando se filtran productos
const updateCartEventListeners = () => {
  setTimeout(setupAddToCartButtons, 100);
}